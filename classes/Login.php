...
class Login
{
    ...
    public function __construct()
    {
        ...
        ParseClient::initialize('uJUkecVnvp90fNExwxXQEphTqcdmVEpDVJE5IWaj', 'Vpooja6i3wKUu5Cbktnb3B6E24gW4XBqO75Q5RZv', 'f1Glt2uC9130m1doKx7JE3rsLbTHP61ha2vF2DwG');
    ...
    private function databaseConnection()
    {
        ...
        if ($this->db_connection != null) {
            ...
            try {
                ...
                #$this->db_connection = new ParseUser();
        ...
        if (isset($_COOKIE['rememberme'])) {
            ...
            if ($hash == hash('sha256', $user_id . ':' . $token . COOKIE_SECRET_KEY) && !empty($token)) {
                ...
                if ($this->databaseConnection()) {
                    ...
                    $result_row = ParseUser::getCurrentUser();
                    if (isset($result_row)) {
    ...
    private function loginWithPostData($user_name, $user_password, $user_rememberme)
    {
        ...
        // if POST data (from login form) contains non-empty user_name and non-empty user_password
            ...
            // if user has typed a valid email address, we try to identify him with his user_email
                ...
                try {
                  $result_row = ParseUser::logIn($user_name, $user_password);
                } catch(ParseException $ex) {
                    // error in $ex->getMessage();
                    echo 'Error logging in: ' . $ex->getMessage();
                }
            }
            ...
            #    $this->errors[] = MESSAGE_ACCOUNT_NOT_ACTIVATED;
                ...
                // write user data into PHP SESSION [a file on your server]
                $_SESSION['user_id'] = $result_row->getObjectId();
                $_SESSION['user_name'] = $result_row->username;
                $_SESSION['user_email'] = $result_row->email;
                $_SESSION['user_logged_in'] = 1;

                // declare user id, set the login status to true
                $this->user_id = $result_row->getObjectId();
